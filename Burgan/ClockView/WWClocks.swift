...
@objc public final class WWCalendarTimeSelectorStylee: NSObject {
...
@objc public enum WWCalendarTimeSelectorSelectionn: Int {
    /// Single Selection.
    case single
...
@objc public enum WWCalendarTimeSelectorMultipleSelectionGroupingg: Int {
...
@objc public enum WWCalendarTimeSelectorMultipleDateOutputFormatt: Int {
    /// English format
    case english
    /// Japanese format
    case japanese
...
@objc public enum WWCalendarTimeSelectorTimeStepp: Int {
...
@objc open class WWCalendarTimeSelectorEnabledDateRangee: NSObject {
    
    public static let past: WWCalendarTimeSelectorEnabledDateRangee = {
        let dateRange = WWCalendarTimeSelectorEnabledDateRangee()
        dateRange.end = Date().endOfDay
        return dateRange
    }()
    
    public static let future: WWCalendarTimeSelectorEnabledDateRangee = {
        let dateRange = WWCalendarTimeSelectorEnabledDateRangee()
...
@objc open class WWCalendarTimeSelectorDateRangee: NSObject {
...
/// The delegate of `WWCalendarTimeSelector` can adopt the `WWCalendarTimeSelectorProtocoll` optional methods. The following Optional methods are available:
///
...
@objc public protocol WWCalendarTimeSelectorProtocoll {
    ...
    @objc optional func WWCalendarTimeSelectorDone(_ selector: WWClocks, dates: [Date])
    ...
    ///     - selector: The selector that will be dismissed.
    ///     - date: Selected date.
    @objc optional func WWCalendarTimeSelectorDone(_ selector: WWClocks, date: Date)
    ...
    ///     - selector: The selector that will be dismissed.
    ///     - dates: Selected dates.
    @objc optional func WWCalendarTimeSelectorCancel(_ selector: WWClocks, dates: [Date])
    ...
    ///     - selector: The selector that will be dismissed.
    ///     - date: Selected date.
    @objc optional func WWCalendarTimeSelectorCancel(_ selector: WWClocks, date: Date)
    ...
    /// - Parameters:
    ///     - selector: The selector that will be dismissed.
    @objc optional func WWCalendarTimeSelectorWillDismiss(_ selector: WWClocks)
    ...
    @objc optional func WWCalendarTimeSelectorDidDismiss(_ selector: WWClocks)
    ...
    @objc optional func WWCalendarTimeSelectorShouldSelectDate(_ selector: WWClocks, date: Date) -> Bool
}

open class WWClocks: UIViewController, WWClockProtocoll {
    
    /// The delegate of `WWClocks` can adopt the `WWCalendarTimeSelectorProtocoll` optional methods. The following Optional methods are available:
    ///
    /// `WWCalendarTimeSelectorDone:selector:dates:`
    /// `WWCalendarTimeSelectorDone:selector:date:`
    /// `WWCalendarTimeSelectorCancel:selector:dates:`
    ...
    /// `WWCalendarTimeSelectorWillDismiss:selector:`
    /// `WWCalendarTimeSelectorDidDismiss:selector:`
    open weak var delegate: WWCalendarTimeSelectorProtocoll?
    ...
    open var optionStyles: WWCalendarTimeSelectorStylee = WWCalendarTimeSelectorStylee()
    ...
    open var optionTimeStep: WWCalendarTimeSelectorTimeStepp = .oneMinute
    ...
    /// - Note:
    /// Selection styles will only affect date selection. It is currently not possible to select multiple/range
    open var optionSelectionType: WWCalendarTimeSelectorSelectionn = .single
    ...
    /// - Note:
    /// Selector will show the earliest selected date's month by default.
    open var optionCurrentDateRange: WWCalendarTimeSelectorDateRangee = WWCalendarTimeSelectorDateRangee()
    ...
    open var optionRangeOfEnabledDates: WWCalendarTimeSelectorEnabledDateRangee = WWCalendarTimeSelectorEnabledDateRangee()
    ...
    ///
    /// `LinkedBalls`: Smaller circular selection, with a bar connecting adjacent dates.
    open var optionMultipleSelectionGrouping: WWCalendarTimeSelectorMultipleSelectionGroupingg = .pill
    ...
    open var optionMultipleDateOutputFormat: WWCalendarTimeSelectorMultipleDateOutputFormatt = .english
    ...
    @IBOutlet fileprivate weak var clockView: WWClockk!
    ...
    fileprivate var selCurrrent: WWCalendarTimeSelectorStylee = WWCalendarTimeSelectorStylee(isSingular: true)
    fileprivate var isFirstLoad = false
    fileprivate var selTimeStateHour = true
    fileprivate var calRow1Type: WWCalendarRowTypee = WWCalendarRowTypee.date
    fileprivate var calRow2Type: WWCalendarRowTypee = WWCalendarRowTypee.date
    fileprivate var calRow3Type: WWCalendarRowTypee = WWCalendarRowTypee.date
    ...
    /// To receive callbacks from selector, set the `delegate` of selector and implement `WWCalendarTimeSelectorProtocoll`.
    ///
    ///     let selector = WWCalendarTimeSelector.instantiate()
    ///     selector.delegate = self
    ///     presentViewController(selector, animated: true, completion: nil)
    ///
    public static func instantiate() -> WWClocks {
        ...
        return UIStoryboard(name: "WWClocks", bundle: bundle).instantiateInitialViewController() as! WWClocks
    }
    ...
    open override func viewDidLoad() {
        ...
        yearRow1 = optionCurrentDate.yearClock - 5
...
//    }
    ...
    @IBAction func selectMonth(_ sender: UIButton) {
        ...
        if delegate?.WWCalendarTimeSelectorShouldSelectDate?(self, date: date) ?? true {
            optionCurrentDate = optionCurrentDate.change(year: date.yearClock, month: date.monthClock, day: date.day).beginningOfDay
            updateDate()
        }
    }
...
@objc internal enum WWCalendarRowTypee: Int {
    case month, day, date
}

internal protocol WWCalendarRowProtocoll: NSObjectProtocol {
    func WWCalendarRowDateIsEnable(_ date: Date) -> Bool
    func WWCalendarRowGetDetails(_ row: Int) -> (type: WWCalendarRowTypee, startDate: Date)
    func WWCalendarRowDidSelect(_ date: Date)
}

internal class WWCalendarRoww: UIView {
    
    internal weak var delegate: WWCalendarRowProtocoll!
    ...
    internal var multipleSelectionGrouping: WWCalendarTimeSelectorMultipleSelectionGroupingg = .pill
...
internal protocol WWClockProtocoll: NSObjectProtocol {
...
internal class WWClockk: UIView {
    
    internal weak var delegate: WWClockProtocoll!
    ...
    internal var minuteStep: WWCalendarTimeSelectorTimeStepp! {
        didSet {
            minutes = []
    ...
    fileprivate let centerPieceSize = 6
