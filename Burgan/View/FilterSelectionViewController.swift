...
class FilterSelectionViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    @IBAction func applyFilter(_ sender: Any) {
        ...
        if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil {
            selectLocationMerchantdelegate?.ClearTheFilter()
        } else {
        ...
        if popupType == 0 {
            ...
            if selectedAccounts.count > 0
            {
                ...
                showAlertDismissOnly(message: AlertMessage(title: "Tijarati".localiz(), body: "Select atleast one account to filter.".localiz()))
            }
            ...
            if FilterSelectionViewController.isBrandSelected{
                ...
                showAlertDismissOnly(message: AlertMessage(title: "Tijarati".localiz(), body: "Select atleast one brand to filter.".localiz()))
            ...
            if selectedLocations.count > 0
            {
                ...
                showAlertDismissOnly(message: AlertMessage(title: "Tijarati".localiz(), body: "Select atleast one location to filter.".localiz()))
            }
...
//            lblTitle.text = "Select Brands".localiz()
        ...
        else
        {
            ...
            searchBar.placeholder = "Search for Location".localiz()
            filteredBrandArr.removeAll()
            originalBrands.removeAll()
            selectedBrands.removeAll()
        ...
        print(filteredAccArr)
        print(filteredBrandArr)
...
//                    let attributeDict = [NSAttributedString.Key.foregroundColor: UIColor.BurganColor.brandGray.lgiht, NSAttributedString.Key.font:UIFont(name: UIFont.Frutiger.light.rawValue, size: 15.0)]
    ...
    func searchBarTextDidBeginEditing(_ searchBar: UISearchBar) {
        ...
        if popupType == 0 {
            filteredAccArr = originalAccounts
        } else if popupType == 1 {
            filteredBrandArr = originalBrands
        } else {
