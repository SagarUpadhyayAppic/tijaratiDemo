...
class SelectLocationViewController : UIViewController, UICollectionViewDelegate, UICollectionViewDataSource,selectLocationMerchantDelegate {
    ...
    func selectMerchantLoaction(account : [String], brand : [String], location : [String]) {
        ...
        AppConstants.ezpayOutletNumber = selectFilterData?.ezpayOutletNumber ?? ""
    }
    ...
    func ClearTheFilter() {
        ...
        AppConstants.selectedFilter!.selectedAccounts.removeAll()
        AppConstants.selectedFilter!.selectedBrands.removeAll()
        AppConstants.selectedFilter!.selectedLocations.removeAll()
        
        
        AppConstants.originalSelectFilter!.selectedAccounts.removeAll()
        AppConstants.originalSelectFilter!.selectedBrands.removeAll()
        AppConstants.originalSelectFilter!.selectedLocations.removeAll()
        
        // UserDefaults.standard.setValue("yes", forKey: "ClearBtnTapped")
        ...
        AppConstants.ezpayOutletNumber = filterdata.ezpayOutletNumber
...
//        // 19/nov/2020
//
//        selAccounts = AppConstants.selectedFilter!.selectedAccounts.count
//        selBrands = AppConstants.selectedFilter!.selectedBrands.count
//        selLocations = AppConstants.selectedFilter!.selectedLocations.count
//
//        cvCompanyList.reloadData()
//        cvCompanyLocationList.reloadData()
//
//        // 19/nov/2020
    ...
    func popupType(type:Int){
        ...
        {
            // BKP condition
            if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil {
                
                let filterdata : FilterDatum = AppConstants.locationFilterData!.filterData[0]
                
                controller.originalAccounts = filterdata.accountList
                controller.selectedAccounts = filterdata.accountList
                
                // 19/Nov/2020
                controller.originalAccounts = originalAccounts
                controller.selectedAccounts = originalAccounts
                // 19/Nov/2020
            ...
            if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil {
                ...
                controller.originalBrands = filterdata.brandList
                controller.selectedBrands = filterdata.brandList
                
                // 19/Nov/2020
                controller.originalBrands = originalBrands
                controller.selectedBrands = originalBrands
                // 19/Nov/2020
            ...
            if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil {
                ...
                controller.originalLocations = filterdata.locationList
                controller.selectedLocations = filterdata.locationList
                
                // 19/Nov/2020
                controller.originalLocations = originalLocations
                controller.selectedLocations = originalLocations
                // 19/Nov/2020
        ...
        // BKP
        if type == 0{
            height = height + CGFloat(60 * controller.originalAccounts.count)
        }else if type == 1{
            height = height + CGFloat(60 * controller.originalBrands.count)
        }else{
            height = height + CGFloat(60 * controller.originalLocations.count)
        }
    ...
    @IBAction func assign(_ sender: Any) {
        ...
        if(isFromProfile){
            ...
            if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil
            {
                ...
                showAlertDismissOnly(message: AlertMessage(title: "".localiz(), body: "Please select location".localiz()))
            }
            else
            {
                delegateFilter?.applyFilter(heirarchy: AppConstants.selectedFilter!, isCif: cif)
    ...
    @IBAction func clearSearchList(_ sender: Any) {
        ...
        /*
         ...
         UserDefaults.standard.setValue("yes", forKey: "ClearBtnTapped")
         //        UserDefaults.standard.setValue("brands", forKey: "ClearBtnTappedBrands")
         //        UserDefaults.standard.setValue("locations", forKey: "ClearBtnTappedLocations")
        ...
        // 19/Nov/2020
        cvCompanyList.selectItem(at: IndexPath(row: 0, section: 0), animated: true, scrollPosition: .left)
        self.collectionView(cvCompanyList, didSelectItemAt: IndexPath(row: 0, section: 0))
        // 19/Nov/2020
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if(collectionView == cvCompanyList)
        {
            if let cell = collectionView.cellForItem(at: indexPath) as? cvCompanyNameCell {
        ...
        if(collectionView == cvCompanyList){
            ...
            if indexPath.row == 0 {
                if SelectLocationViewController.selectedfinalAcc.count > 0
                {
                    ...
                    if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil {
                        cell.lblName.text = "Acc No.:".localiz() + " " +  String(selAccounts)
                    } else {
                        cell.lblName.text = "Acc No.:".localiz() + " " +  String(SelectLocationViewController.selectedfinalAcc.count)
                    }
                }else{
                    cell.lblName.text = "Acc No.:".localiz() + " " +  String(selAccounts)//(AppConstants.selectedFilter!.selectedAccounts.count)
                }
                ...
                if SelectLocationViewController.selectedfinalBrand.count > 0
                {
                    ...
                    if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil {
                        cell.lblName.text = "Brand :".localiz() + " " + String(selBrands)
                    } else {
                        cell.lblName.text = "Brand :".localiz() + " " +  String(SelectLocationViewController.selectedfinalBrand.count)
                    }
                }else{
                    cell.lblName.text = "Brand :".localiz() + " " + String(selBrands)//(AppConstants.selectedFilter!.selectedBrands.count)
                }
                ...
                if SelectLocationViewController.selectedfinalLocation.count > 0
                {
                    ...
                    if UserDefaults.standard.value(forKey: "ClearBtnTapped") != nil {
                        cell.lblName.text = "Location :".localiz() + " " +  String(selLocations)
                    } else {
                        cell.lblName.text = "Location :".localiz() + " " +  String(SelectLocationViewController.selectedfinalLocation.count)
                    }
                }else{
                    cell.lblName.text = "Location :".localiz() + " " +  String(selLocations)//(AppConstants.selectedFilter!.selectedLocations.count)
                }
            }
